...
import Logo1 from "../assets/img/Banner-2.jpg";
import Logo2 from "../assets/img/Banner-3.jpg";
import Logo3 from "../assets/img/Bannner-4.jpg";
import Logo4 from "../assets/img/Banner-5.jpg";
import Logo5 from "../assets/img/Banner-6.jpg";
import Logo6 from "../assets/img/Banner-7.jpg";
import Logo7 from "../assets/img/Banner-8.jpg";
import Logo8 from "../assets/img/open-menu.png";
import Logo9 from "../assets/img/shopping-cart.png";
import Logo10 from "../assets/img/handphone.png";
import Logo11 from "../assets/img/ticket.png";
import Logo12 from "../assets/img/cook.png";
import Logo13 from "../assets/img/sofa.png";
import Logo14 from "../assets/img/parfum.png";
import Logo15 from "../assets/img/plane.png";
import Logo16 from "../assets/img/globe.png";
import Logo17 from "../assets/img/customer.jpg";
...
export default function Hero() {
  ...
  return (
    <div style={{ padding: `0 ${chevronWidth}px` }}>
      ...
      <div style={{ padding: `0 ${chevronWidth}px` }}>
        ...
        >
          ...
          >
            ...
            >
              {" "}
              <img src={Logo8} alt="memew" style={{padding: "5px",width: "25px", height: "20px", marginRight: "5px", marginBottom: "-10px"}} />
              Semua 
            </a>
          </div>
          <div
          ...
          >
            <a
              href="#"
              style={{ padding: "5px", textDecoration: "none", color: "black", marginLeft: "10px" }}
            >
              <img src={Logo9} alt="aaaah" style={{padding: "5px", width: "25px", height: "20px", marginRight: "5px", marginBottom : "-9px"}} />
              Bliblimart
            </a>
          </div>
          <div
          ...
          >
            <a
              ...
              style={{ padding: "5px", textDecoration: "none", color: "black" }}
            >
              <img src={Logo10} alt="pulsa" style={{padding: "5px", width: "25px", height: "25px", alignItems: "center", lineHeight: "1.14", WebkitBoxAlign: "center", marginLeft: "-5px", marginBottom: "-10px", marginRight: "10px", textAlign: "center", justifyContent: "center"}}  />
              Pulsa
            </a>
          </div>
          <div
          ...
          >
            <a
              ...
              style={{ padding: "5px", textDecoration: "none", color: "black" }}
            >
            <img src={Logo12} alt="cook" style={{padding: "5px", width: "25px", height: "25px", alignItems: "center", lineHeight: "1.14", WebkitBoxAlign: "center", marginLeft: "-5px", marginBottom: "-10px", marginRight: "10px", textAlign: "center", justifyContent: "center"}} />
              Elektronik
            </a>
          </div>
          <div
          ...
          >
            <a
              ...
              style={{ padding: "5px", textDecoration: "none", color: "black" }}
            >
              <img src={Logo15} alt="pesawat" style={{padding: "5px", width: "25px", height: "25px", alignItems: "center", lineHeight: "1.14", WebkitBoxAlign: "center", marginLeft: "-5px", marginBottom: "-15px", marginRight: "10px", textAlign: "center", justifyContent: "center"}}/>
              Pesawat
            </a>
          </div>
          <div
      ...
      <div className="grid" style={{opacity: "10", 
      boxShadow: '0 0 24px -4px rgba(0,0,0,.12)', 
      width: '1220px', 
      height: "56px", 
      padding: '0 4px', 
      ...
      marginRight: "100px",
      marginTop: "40px",
      background: "-webkit-gradient(linear,left top,right top,from(#3795d9),color-stop(35%,#3795d9),to(#00d4ff))",
      color : "white"
      }} >
        <div className="box1" style={{fontFamily: "effra,Helvetica,Arial,sans-serif"}}>
